        ...
        for (const ele of data.properties) {
          switch (ele.propname) {
            ...
            case this.knoraService.mlsOntology + 'hasArticleText': {
              ...
              const regexSwitchtube = /<oembed +?url="https?:\/\/tube\.switch\.ch\/videos\/([a-zA-Z0-9_-]{10})"><\/oembed>/g;
              ...
              articledata.arttext = articledata.arttext.replace(regexSwitchtube, '<iframe width="560" height="315" src="https://tube.switch.ch/embed/$1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
