    ...
    <mat-dialog-content>
      <mat-card class="maxw" xmlns="http://www.w3.org/1999/html">
        ...
        <mat-card-content [formGroup]="form">
          ...
          <button *ngIf="valIds.text.changed" mat-mini-fab (click)="_handleUndo('text')"><mat-icon color="warn">cached</mat-icon></button>
          <br/>
          ...
          <button *ngIf="valIds.type.changed" mat-mini-fab (click)="_handleUndo('type')"><mat-icon color="warn">cached</mat-icon></button>
          <br/>
          ...
          <button *ngIf="valIds.givenName.changed" mat-mini-fab (click)="_handleUndo('givenName')"><mat-icon color="warn">cached</mat-icon></button>
          <br/>
          ...
          <button *ngIf="valIds.familyName.changed" mat-mini-fab (click)="_handleUndo('familyName')"><mat-icon color="warn">cached</mat-icon></button>
          <br/>
          ...
          <button *ngIf="valIds.deceased.changed" mat-mini-fab (click)="_handleUndo('deceased')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.startDate.changed" mat-mini-fab (click)="_handleUndo('startDate')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.startDateInfo.changed" mat-mini-fab (click)="_handleUndo('startDateInfo')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.endDate.changed" mat-mini-fab (click)="_handleUndo('endDate')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.endDateInfo.changed" mat-mini-fab (click)="_handleUndo('endDateInfo')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.century.changed" mat-mini-fab (click)="_handleUndo('century')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.sex.changed" mat-mini-fab (click)="_handleUndo('sex')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.relevance.changed" mat-mini-fab (click)="_handleUndo('relevance')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.viaf.changed" mat-mini-fab (click)="_handleUndo('viaf')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.gnd.changed" mat-mini-fab (click)="_handleUndo('gnd')"><mat-icon color="warn">cached</mat-icon></button>
          ...
          <button *ngIf="valIds.comment.changed" mat-mini-fab (click)="_handleUndo('comment')"><mat-icon color="warn">cached</mat-icon></button>
...
export class EditlemComponent implements OnInit {
  ...
  constructor(public knoraService: KnoraService,
              ...
              private dialogRef: MatDialogRef<EditlemComponent>,
